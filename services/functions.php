...
<html>
    ...
    *{
        ...
        // font-family: 'Iimes New Roman', serif;
        outline: none;
        border: none;
	...
	<body>
        <header>
            ...
            <img class="logo" src="logo_carehub.jpeg" alt="logo">
                <h1>Personilized Plant Care <br> <i class="fa-solid"></i></h1>
                <nav>
                    <a href="../home/index.php">Home</a>
                    <a href="index.php">Details</a>
                    <a href="index.php?page=products">Services</a>
                    <a href="index.php?page=book">Orders</a>
                </nav>
