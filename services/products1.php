...
$stmt = $pdo->prepare('SELECT * FROM category where `title`= "pet" OR `title`= "petcare" ORDER BY date_added DESC LIMIT ?,?');
...
$total_products = $pdo->query('SELECT * FROM category where `title`= "pet" OR `title`= "petcare"')->rowCount();
?>
