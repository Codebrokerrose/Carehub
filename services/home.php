...
$stmt = $pdo->prepare('SELECT * FROM category where `title`LIKE "%garden%" OR `title` LIKE "%plant%" ORDER BY date_added DESC LIMIT 4');
$stmt->execute();
...
<script src="https://kit.fontawesome.com/cf90a6dd12.js" crossorigin="anonymous"></script>
  <link rel="stylesheet" href="service_style.css">
    ...
    <div id="productVideo">
        <div >
            <button style="margin-left:50px;font-size:16px;"><img
                    src="planticon.png"
