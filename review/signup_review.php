    ...
    <div class="wrapper">
        <nav class="nav">
            ...
            <div class="nav-button">
                <button id="loginBtn" class="Btn "><a href="signin_review.php">Sign in</a> </button>
                <button id="registerBtn" class="Btn white-btn"><a href="signup_review.php">Sign up</a> </button>
            </div>
