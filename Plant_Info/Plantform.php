...
<section id="page-header" class="about-header" style="background-image: url(/carehub/img/banner/tree.jpeg);">
    <h2>#let's_talk</h2>
...
<section id="form">
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $sql = "SELECT Watering_Timings FROM PlantInfo WHERE plant_name=? AND Soil_Type=? AND Temperature=?";
        ...
        if ($result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
                echo "<div class='alert alert-success mt-3' role='alert'>
                            Watering Timings: " . $row["Watering_Timings"] . "
                          </div>";
            }
        } else {
