...
<body>
    <section id="Home">
        ...
        <!-- navigation -->
    <?php include 'nav.php'; ?>
    <div class="top-nav" style="margin-left:130px">
        <a href="../../carehub-vendor\public_html\vendor\index.php" >Vendor login   </a>
        <!-- <a href="../../carehub-admin\public_html\admin\index.php"> &nbsp; Admin Login</a> -->
    </div>
        <!-- login/registration  -->
        <!-- <div class="log">
        ...
        <div class="contain">
           ...
           <br>
            ...
            <div id="next" style="color: white; background:none;font-size: 50px;" onclick="next()">></div>
            <div id="prev" style="color: white; background:none;font-size: 50px;"  onclick="prev()"><</div>
        </div>
    ...
    <form class=button_2 action="../services/index.php">
    ...
    <form class=button_2 action="../services/index1.php">
    ...
    <form class=button_2 action="../services/index2.php">
  ...
  <div class="image-gallery">
    ...
    <div class="image-gallery-images">
      <img src="../plant_info/collag.jpeg" alt="Image 1" height=500px width=550px>
  ...
  <!--------------------End of the categories------------------------>
  <hr>
  <section id="banner" class="section-m1" style="background-image: url('../plant_info/gardenbanner1.jpg.webp');">
