            ...
            <div class="row">
              <div class="col-md-12">
                <div class="row">
                 ...
                 ?>
                          <div class="stat-panel-number h1 "><?php echo $fusers['total'];?></div><br>
                          <div class="stat-panel-title text-uppercase">Total Vendors</div>
                        </div>
                      </div>
                      <a href="vendorlist.php" class="block-anchor panel-footer">Full Detail <i class="fa fa-arrow-right"></i></a>
                    </div>
                  </div>
